...
function getCategories(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT categories.name AS category_name FROM categories ORDER BY name')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.oppervlakte AS oppervlakte, products.inwoners AS inwoners, products.continent AS continent, products.code AS code, products.price AS price FROM products WHERE id = ?')
